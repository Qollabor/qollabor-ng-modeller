...
class HumantaskModelEditor extends ModelEditor {
                    ...
                    <div>
                        <div class="model-content-viewer">
                            <div class="task-preview-header">
                                <h3>Preview</h3>
                                <label>Note: the preview below is rendered with <a target="_blank" href="http://www.alpacajs.org/">AlpacaJS</a>; Qollabor UI uses <b><a target="_new" href="https://react-jsonschema-form.readthedocs.io">React JSON Schema Forms</a></b>, which renders slightly different.</label>
                                <br />
    ...
    static createNewModel(ide, name, description) {
        const newModelContent = 
            `<humantask>
                <${IMPLEMENTATION_TAG} name="${name}" description="${description}" ${IMPLEMENTATION_PREFIX}="${IMPLEMENTATION_NAMESPACE}" class="org.qollabor.cmmn.definition.task.WorkflowTaskDefinition">
